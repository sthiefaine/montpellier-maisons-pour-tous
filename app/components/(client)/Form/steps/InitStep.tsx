...
export default function InitStep({ formData, setFormData, onNext }: InitStepProps) {
  ...
  const handleImport = () => {
    try {
      ...
      const updatedForms = [...previousForms, ...validForms.map(form => ({
        ...form,
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Je souhaite inscrire un enfant ou une autre personne aux activités</p>
          </button>
        </div>
      </div>
                    ...
                    <div className="mt-2 space-y-1.5">
                      ...
                      <div className="flex flex-wrap gap-x-4 text-sm text-gray-500">
                        <p className="flex items-center gap-1">
                          <span className={`inline-block w-2 h-2 rounded-full ${form.mineur ? 'bg-blue-400' : 'bg-green-400'}`}></span>
                        ...
                        <p className="flex items-center gap-1">
                          ...
                          {form.updatedAt ? 'Modifié' : 'Créé'} le {new Date(form.updatedAt || form.createdAt).toLocaleDateString('fr-FR', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric',
                            hour: '2-digit',
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700 font-medium">
                      Note : Les signatures ne sont pas incluses dans l'export pour des raisons de sécurité.
                    </p>
                  </div>
                </div>
              </div>
